...
export const metadata:Metadata={description,alternates:{canonical:"/plan/draw/3d"},openGraph:{title,description,url:"/plan/draw/3d",type:"website",images:[{url:"/og.png",width:1200,height:630,alt:"Dormscape 3D Room Builder"}]},twitter:{card:"summary_large_image",title,description,images:["/og.png"]}};
