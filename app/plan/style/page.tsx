...
export default function PlanStylePage() {
  ...
  function handleBudget(value: number) {
    ...
    budgetTrackTimer.current = setTimeout(
      () => track("budget_set", { amount: value }),
      700,
    );
  }
  ...
  if (!mounted || !room) {
    return (
      <div
        className="mx-auto max-w-3xl space-y-4 px-5 sm:px-8"
        aria-busy="true"
  ...
  return (
    <div className="dm-planner-style">
      ...
      <div className="dm-style-columns">
        ...
        <div className="dm-style-aside">
          ...
          <div className="dm-budget-card mt-8 rounded-xl border border-ink/10 bg-white p-5 sm:p-6">
            ...
            <p
              className="mt-4 min-h-10 text-sm leading-relaxed text-ink-soft"
              aria-live="polite"
            >
              {covered ? (
                <>
