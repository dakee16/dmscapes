...
export default function StudioShowcase() {
  ...
  return <section ref={section} id="room-in-3d" className={s.showcase} data-paused={paused} aria-labelledby="showcase-title">
    <div className={s.sticky}>
      ...
      <div className={s.topline}><span><i/> THE ROOM STUDIO / LIVE NOW</span><span className={s.pro}>INCLUDED WITH PRO ↗</span></div>
      <div className={s.content}>
        ...
        <div className={s.visual}>
          ...
          <div className={s.sceneCaption}><span className={s.sceneNumber}>0{active+1}</span><span>{["Start with your floor plan.","Every piece, in its place.","Your move-in, previewed."][active]}</span><span aria-hidden="true">↗</span></div>
        </div>
      </div>
