...
export default function StyleCard({
  ...
  return (
    <button
      ...
      className={`dm-style-card group relative flex w-full flex-col items-start overflow-hidden rounded-xl border-2 bg-white text-left transition-all duration-200 ease-out will-change-transform active:translate-y-0 active:scale-[0.99] active:duration-75 motion-reduce:transform-none motion-reduce:transition-none ${
        selected
