        ...
        <div className="relative overflow-hidden rounded-2xl border border-ink/12 bg-card p-8 sm:p-12">
          ...
          <div className="relative max-w-2xl">
            ...
            <p className="mt-4 text-lg leading-relaxed text-ink-soft">
              ...
              Plus adds {PLUS_INITIAL_CREDITS} more, plus comparing two rooms side by side,
              exporting the winner, and designing in all nine preset vibes.
          ...
          <div className="relative mt-4 flex flex-col items-start gap-2 rounded-xl border border-highlight/60 bg-highlight/[0.12] px-4 py-3.5 sm:flex-row sm:items-center sm:gap-3">
            ...
            <p className="text-sm leading-relaxed text-ink-soft">
              ...
              list, or an unusual shape? Sketch your floor plan in 2D, add doors
          ...
          <div className="relative mt-4 flex flex-col items-start gap-2 rounded-xl border border-cobalt/25 bg-cobalt/[0.05] px-4 py-3.5 sm:flex-row sm:items-center sm:gap-3">
            ...
            <p className="text-sm leading-relaxed text-ink-soft">
              ...
              presets and describe your aesthetic in your own words. We match real
              products to it. Pro also includes live 3D planning and the <Link href="/plan/draw/3d" className="text-cobalt underline">3D Room Builder</Link>.
            </p>
          </div>
