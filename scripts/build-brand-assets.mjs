...
const source = "public/brand/dormscape-source.jpg";
...
const sizes=[16,32,48],images=await Promise.all(sizes.map(size=>sharp(source).resize(size,size).ensureAlpha().png().toBuffer()));
...
<text x="540" y="160" font-size="15" letter-spacing="3" fill="#2b4eff">MAKE ROOM FOR YOUR NEXT CHAPTER</text>
<text x="538" y="255" font-size="67" font-weight="bold" letter-spacing="-3">dormscape</text>
<text x="540" y="332" font-size="32">Your dorm.</text><text x="540" y="378" font-size="32">Planned before move-in.</text>
<text x="540" y="443" font-size="18" fill="#656675">2D planning · Live 3D with Pro</text>
<rect x="540" y="478" width="216" height="51" fill="#ffdc60"/><text x="565" y="511" font-size="21" font-weight="bold">dormscape.us</text>
</g></svg>`;
